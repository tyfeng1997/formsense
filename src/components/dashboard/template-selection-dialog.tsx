...
import { FileText, Plus, Loader2, Scan } from "lucide-react";
...
interface TemplateSelectionDialogProps {
  ...
  onExtractAllFields?: () => void; // New prop for extract all fields
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              {onExtractAllFields && (
                <button
                  ...
                  className="flex items-start gap-4 p-4 rounded-lg border border-green-200 hover:border-green-300 hover:bg-green-50/30 transition-all hover:shadow-md w-full text-left"
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Automatically detect and extract all fields from the form
                      without a template.
                    </p>
                  </div>
                </button>
