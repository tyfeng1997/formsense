...
export const TemplateSupabaseStorage = {
  ...
  async initializeDefaults(): Promise<void> {
    ...
    if (checkError) {
      console.error("Failed to check for existing templates:", checkError);
      return;
    }

    // If user already has templates, don't create defaults
...
if (typeof window !== "undefined") {
  TemplateSupabaseStorage.initializeDefaults().catch((err) => {
